...
<title>Platform Auditor Report — ${portalName}</title>
<style>
...
<div class="page" style="min-height:100vh;display:flex;flex-direction:column;justify-content:space-between">
  <div>
    ...
    <div style="background:#0F172A;border-radius:12px;padding:24px 32px;margin-bottom:48px;display:flex;justify-content:space-between;align-items:center">
      <div>
        <div style="font-size:22px;font-weight:800;color:white;letter-spacing:-0.5px">Platform <span style="color:#FB923C">Auditor</span></div>
...
<div class="page page-break">
  ...
  <div style="margin-top:40px;padding-top:20px;border-top:1px solid #E5E7EB;text-align:center">
    <p style="font-size:11px;color:#9CA3AF">Generated by Platform Auditor • ${auditDate} • Model: ${analysis.modelUsed}</p>
